...
> Could not resolve all dependencies for configuration ':detachedConfiguration3'.
   > Could not resolve org.springframework.boot:spring-boot-dependencies:2.2.13.RELEASE.
     Required by:
         project :
      > Could not resolve org.springframework.boot:spring-boot-dependencies:2.2.13.RELEASE.
         > Could not get resource 'https://nexus-qa.itpreprodb.com/repository/maven-central/org/springframework/boot/spring-boot-dependencies/2.2.13.RELEASE/spring-boot-dependencies-2.2.13.RELEASE.pom'.
            > Could not HEAD 'https://nexus-qa.itpreprodb.com/repository/maven-central/org/springframework/boot/spring-boot-dependencies/2.2.13.RELEASE/spring-boot-dependencies-2.2.13.RELEASE.pom'.
               > Read timed out
